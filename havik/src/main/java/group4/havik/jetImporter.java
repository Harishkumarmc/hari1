 ...
 * @author sri
 */
@Component(name = "jetImporterComponent", factory = "PepperImporterComponentFactory")
public class jetImporter extends PepperImporterImpl implements PepperImporter{
	/** this is a logger, for recording messages during program process, like debug messages**/
	private static final Logger logger = LoggerFactory.getLogger(jetImporter.class);
	 ...
	 * sample mapper of type {@link jetMapper}, which only produces a fixed
	 * document-structure in method {@link jetMapper#mapSDocument()} and
	 * enhances the corpora for further meta-annotations in the method
	 * {@link jetMapper#mapSCorpus()}. <br/>
	 ...
	 * {@link jetMapper#mapSDocument()} and enhances the corpora for further
	 * meta-annotations in the method {@link jetMapper#mapSCorpus()}. <br/>
	 ...
	 *
	 */
	public static class jetMapper extends PepperMapperImpl {
		/**
		 * <strong>OVERRIDE THIS METHOD FOR CUSTOMIZATION</strong> <br/>
