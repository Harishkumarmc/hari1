...
import group4.havik.jetImporter;
 ...
 * {@link jetImporter} class. Feel free to adapt and enhance this test class
 ...
 * @author sri
 */
public class jetImporterTest extends PepperImporterTest {
	/**
	...
	public void test_DummyImplementation() {
		...
		getFixture().getCorpusDesc().setCorpusPath(getTempURI("jetImporter"));
